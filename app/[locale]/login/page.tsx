...
export default function LoginPage() {
  ...
  return (
    <RouteGuard guestOnly tone="dark">
      <div className="flex h-full flex-col items-center justify-center overflow-y-auto bg-midnight px-4 py-12">
        <div className="flex w-full max-w-[420px] flex-col items-center">
          ...
          <form
            onSubmit={onSubmit}
            className="admin-card w-full rounded-2xl px-8 py-8"
          >
            <div className="space-y-2">
              <h1 className="text-[22px] font-semibold tracking-tight text-white">
                {t("title")}
              </h1>
              <p className="max-w-sm text-[13px] leading-6 text-white/50">
                {t("subtitle")}
              </p>
            </div>
            ...
            <Button
              type="submit"
              className="mt-7 h-11 w-full text-[14px]"
              disabled={submitting}
            >
